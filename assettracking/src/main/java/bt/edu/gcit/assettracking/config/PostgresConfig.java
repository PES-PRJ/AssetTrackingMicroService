...
public class PostgresConfig {
    ...
    private static final String DB_URL = "jdbc:postgresql://dpg-d88t5067r5hc73cqscu0-a.singapore-postgres.render.com:5432/ams_database_6gir";

    private static final String DB_USERNAME = "ams";
    private static final String DB_PASSWORD = "u5B4edKT5SyrH2WI1Fzw9VdeLyTXN9cu";
